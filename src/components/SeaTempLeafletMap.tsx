    ...
    useEffect(() => {
        ...
        const initMap = async () => {
            ...
            legend.onAdd = function () {
                const div = (L as any).DomUtil.create('div', 'leaflet-legend');
                div.innerHTML = `
                    <div style="
                        background: ${legendBg};
                        color: ${legendText};
            ...
            if (locations.length > 0) {
                ...
                const stats = (L as any).control({ position: 'bottomleft' });
                stats.onAdd = function () {
                    const div = (L as any).DomUtil.create('div', 'leaflet-stats');
                    div.innerHTML = `
                        <div style="
                            background: ${legendBg};
                            color: ${legendText};
