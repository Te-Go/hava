...
export const openMeteoSchema = z.object({
  ...
  hourly: z.object({
    ...
    snow_depth: z.array(z.number()).catch([0]),
  }).catch({
    time: [''], temperature_2m: [0], precipitation_probability: [0], precipitation: [0], weather_code: [0], is_day: [0], wind_speed_10m: [0], wind_direction_10m: [0], apparent_temperature: [0], relative_humidity_2m: [0], uv_index: [0], visibility: [0], surface_pressure: [0], snow_depth: [0]
  }),
  daily: z.object({
    time: z.array(z.string()).catch(['']),
    weather_code: z.array(z.number()).catch([0]),
...
export const sanitizeOpenMeteoPayload = (data: unknown) => {
  try {
    ...
    return {
      ...
      hourly: { time: [''], temperature_2m: [0], precipitation_probability: [0], precipitation: [0], weather_code: [0], is_day: [0], wind_speed_10m: [0], wind_direction_10m: [0], apparent_temperature: [0], relative_humidity_2m: [0], uv_index: [0], visibility: [0], surface_pressure: [0], snow_depth: [0] },
